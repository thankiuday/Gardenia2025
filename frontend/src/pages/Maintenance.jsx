        ...
        >
          ...
          >
            ...
            <motion.div
              ...
              className="w-16 h-16 bg-emerald-100 rounded-full flex items-center justify-center mx-auto mb-8"
            >
              ...
              <div className="flex justify-center">
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">info@gardencity.university</p>
                  </div>
                </div>
              </div>
            </motion.div>
            ...
            >
              ...
              <div className="flex justify-center space-x-4">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-10 h-10 bg-[#FF0000] rounded-full flex items-center justify-center text-white hover:scale-110 transition-transform duration-200"
                  aria-label="YouTube"
                >
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
