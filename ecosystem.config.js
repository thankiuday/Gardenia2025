...
module.exports = {
  apps: [
    ...
    },
    {
      ...
      script: 'serve',
      cwd: '/var/www/Gardenia2025/frontend',
      args: '-s dist -l 3001',
      instances: 1,
      exec_mode: 'fork',
      env: {
      ...
      error_file: '/var/log/pm2/gardenia2025-frontend-error.log',
      out_file: '/var/log/pm2/gardenia2025-frontend-out.log',
      log_file: '/var/log/pm2/gardenia2025-frontend.log',
      time: true,
      ...
      autorestart: true,
      // Watch for file changes in production (for zero-downtime updates)
      watch: false,
